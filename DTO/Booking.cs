...
namespace DTO
{
    public class Booking
    {
        ...
        private string _date_book;
        private string _date_checkin;
        private string _date_checkout;
        ...
        public string Date_book { get => _date_book; set => _date_book = value; }
        public string Date_checkin { get => _date_checkin; set => _date_checkin = value; }
        public string Date_checkout { get => _date_checkout; set => _date_checkout = value; }
        public double Deposit { get => _deposit; set => _deposit = value; }

        public Booking(string id, string code_room, string code_customer,string date_checkin,string date_checkout, string deposit,string date_book)
        {
            this.Id_booking = id;
